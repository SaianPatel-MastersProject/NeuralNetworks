...
for i = 1:size(data, 2)
    ...
    dataArray_i = [data_i.CTE, lookAheadKappa_0, lookAheadKappa, data_i.steerAngle ];
...
trainingDataNorm = minMaxNormalize(trainingData(:, 1:3));
trainingDataNorm = [trainingDataNorm, trainingData(:,4)];
...
%% View Input Space
plotInputSpace(trainingDataStand, [1:4]);
