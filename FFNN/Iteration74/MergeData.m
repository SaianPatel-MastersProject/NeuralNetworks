...
for i = 1:size(data, 2)
    ...
    % [dLookOverall, kappaSorted] = Utilities.fnLookAheadDistanceSigmoidCurvature3(6, 30, 200, 0.01, 0.1);
    ...
    kappaIntegral = zeros([size(data_i, 1), 1]);
    ...
    for j = 1:size(data_i, 1)
        ...
        % Integrate curvature
        distVector = (1:40);
        kappaIntegral(j,1) = trapz(distVector, kappaIntegrate);
    ...
    dataArray_i = [data_i.CTE, lookAheadKappa_0, data_i.HeadingError, lookAheadKappa, kappaIntegral, data_i.steerAngle ];
