%% Runs and Laps
runsLaps = {
    'D:\Users\Saian\Workspace\Data\+ProcessedData\2025\FYP01_27\2025_FYP01_27_D2_R03.mat';
};
...
for i = 1:size(runsLaps, 1)
    ...
    matFilePath = runsLaps{i,1};
     ...
     runData = runData(runData.lapNumber < 109, :);
...
for i = 1:size(data, 2)
    ...
    for j = 1:size(data_i, 1)
        ...
        % Look Ahead in Kappa
        lookAhead_i = Utilities.fnGetLookAheadValues(kappaInterp, closestWaypointIdx, 500, 5);
