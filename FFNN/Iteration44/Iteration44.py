...
data = pd.read_csv('Iteration44\\TrainingData.csv')

# Separate input features (first 4 columns) and output (5th column)
X = data.iloc[:, :6].values  # First 4 columns as input features
y = data.iloc[:, 6].values   # 5th column as output
...
model.export("Iteration44\\SteeringModel_Iteration44")