...
data = pd.read_csv('Iteration20\\TrainingData.csv')

# Separate input features (first 4 columns) and output (5th column)
X = data.iloc[:, :10].values  # First 4 columns as input features
y = data.iloc[:, 10].values   # 5th column as output
...
model.export("Iteration20\\SteeringModel_Iteration20")