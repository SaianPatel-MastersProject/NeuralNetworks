...
net = importNetworkFromONNX("SteeringModel_Iteration56.onnx", "InputDataFormats", "BC");
...
[dLookOverall, kappaSorted] = Utilities.fnLookAheadDistanceSigmoidCurvature2(3, 30, 10000, 0.8e-3, kappaInterp);
...
for i = 1:size(runStruct.data, 1)
    ...
    dLookAhead = interp1(kappaSorted, dLookOverall, abs(dCurvatureCol(i)));
