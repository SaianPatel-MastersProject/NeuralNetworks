...
obj = obj.addRun('D:\Users\Saian\Workspace\Data\+ProcessedData\2025\FYP04_07\2025_FYP04_07_D5_R04.mat', true, [1:17]); % SM75_SP


% Add reference lap
obj = obj.addLap('D:\Users\Saian\Workspace\Data\+ProcessedData\2025\FYP02_03\2025_FYP02_03_D1_R02.mat', 31); % SP
obj = obj.addLap('D:\Users\Saian\Workspace\Data\+ProcessedData\2025\FYP04_07\2025_FYP04_07_D5_R04.mat', 17); % SM75_SP


% Overwrite the legend cell
obj.plottingTools.legendCell = {'SP', 'NP'};
...
obj.plotLineDistributionPerCorner(2, true, [2])
...
avgMetricsCTE(5,:) = mean(obj.runData(5).metricsCTE,1);
...
avgMetricsSteer(5,:) = mean(obj.runData(5).metricsSteer,1);
