...
net = importNetworkFromONNX("SteeringModel_Iteration78.onnx", "InputDataFormats", "BC");
...
for i = 1:size(runStruct.data, 1)
    ...
    yawRateOutput_i = predict(net, input_i);

    % Convert back to steering
    yawRateOutput = (yawRateOutput_i * stanArray(2, end)) + stanArray(1, end);
    steeringOutput_i = yawRateOutput / -1.5;
