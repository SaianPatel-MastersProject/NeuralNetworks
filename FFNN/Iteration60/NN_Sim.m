...
net = importNetworkFromONNX("SteeringModel_Iteration60.onnx", "InputDataFormats", "BC");
...
for i = 1:size(runStruct.data, 1)
    ...
    [~,~,HE_smooth] = PostProcessing.PE.fnCalculatePathErrorLA(currentPose, AIW_Data, 30);
