...
data = pd.read_csv('Iteration21\\TrainingData.csv')

# Separate input features (first 4 columns) and output (5th column)
X = data.iloc[:, :9].values  # First 4 columns as input features
y = data.iloc[:, 9].values   # 5th column as output
...
model.export("Iteration21\\SteeringModel_Iteration21")