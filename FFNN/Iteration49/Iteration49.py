...
data = pd.read_csv('Iteration49\\TrainingDataNorm.csv')

# Separate input features (first 4 columns) and output (5th column)
X = data.iloc[:, :3].values  # First 4 columns as input features
y = data.iloc[:, 3].values   # 5th column as output
...
model.export("Iteration49\\SteeringModel_Iteration49")