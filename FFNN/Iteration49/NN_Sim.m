...
net = importNetworkFromONNX("SteeringModel_Iteration49.onnx", "InputDataFormats", "BC");

%% Read in Training Data and Produce minMaxTable
...
for i = 1:size(runStruct.data, 1)
    ...
    input_i = [CTE, HeadingError, lookAhead_i];
    ...
    % Populate the array
    NN_Sim_Data(i,2:4) = input_i;
    NN_Sim_Data(i,5) = steeringOutput_i;
