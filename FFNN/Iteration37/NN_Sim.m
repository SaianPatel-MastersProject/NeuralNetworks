...
net = importNetworkFromONNX("SteeringModel_Iteration37.onnx", "InputDataFormats", "BC");
...
matFilePath = 'D:\Users\Saian\Workspace\Data\+ProcessedData\2025\FYP01_27\2025_FYP01_27_D2_R03.mat';
lap = 107;
...
for i = 1:size(runStruct.data, 1)
    ...
    input_i = [CTE,curvature, HeadingError];
