...
figure;
subplot(3,1,1)
boxplot(table2array(trainingData), 'Labels', trainingData.Properties.VariableNames);
grid on;
grid minor;

subplot(3,1,2)
boxplot(table2array(trainingDataNorm), 'Labels', trainingDataNorm.Properties.VariableNames);
grid on;
grid minor;

subplot(3,1,3)
boxplot(table2array(trainingDataStand), 'Labels', trainingDataStand.Properties.VariableNames);
grid on;
grid minor;
