...
data = pd.read_csv('D:\\Users\\Saian\\Workspace\\Data\\+NN\\+Iteration2\\TrainingData.csv')
...
# Save the model
model.save("Iteration2\\steering_fnn_model_saved.h5")
...
model.export("Iteration2\\steering_model_NN")