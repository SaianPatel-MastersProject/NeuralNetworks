...
net = importNetworkFromONNX("SteeringModel_Iteration3.onnx", "InputDataFormats", "BC");

%% Import Reference Run

matFilePath = 'D:\Users\Saian\Workspace\Data\+ProcessedData/2024/FYP12_16/2024_FYP12_16_D7_R01.mat';
lap = 19;
...
for i = 1:size(runStruct.data, 1)
    ...
    yawRateCol = runStruct.data.steerAngle * -1.5;
