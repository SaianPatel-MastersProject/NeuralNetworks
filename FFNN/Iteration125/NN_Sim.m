...
net = importNetworkFromONNX("SteeringModel_Iteration125.onnx", "InputDataFormats", "BC");
...
for i = 1:size(runStruct.data, 1)
    ...
    input_i = [CTE, lookAhead_0, HeadingError, lookAhead_i, prevSteering1, prevSteering1*-1.425, projectedCTE, lookAheadHE_i];
