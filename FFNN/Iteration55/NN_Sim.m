...
net = importNetworkFromONNX("SteeringModel_Iteration55.onnx", "InputDataFormats", "BC");
...
dSteerCol = [0; diff(runStruct.data.steerAngle)] ./ 0.01;
...
for i = 1:size(runStruct.data, 1)
    ...
    input_i = [CTE, lookAhead_0, HeadingError, lookAhead_i, dSteer];
