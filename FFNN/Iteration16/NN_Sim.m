...
net = importNetworkFromONNX("SteeringModel_Iteration16.onnx", "InputDataFormats", "BC");
...
for i = 51:size(runStruct.data, 1)
    ...
    for k = 1:5
        ...
        prevSteer_k(1,k) = runStruct.data.steerAngle(i - (k*10));

    end

    prevSteer = prevSteer_k;

    input_i = [CTE, dCTE, curvature, dCurvature, HeadingError, prevSteer];
