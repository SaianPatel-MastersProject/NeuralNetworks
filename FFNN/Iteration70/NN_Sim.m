...
net = importNetworkFromONNX("SteeringModel_Iteration70.onnx", "InputDataFormats", "BC");
...
for i = 1:size(runStruct.data, 1)
    ...
    % Undo minMaxNorm
    yawRate_i = 0.5 * (yawRateOutput_i + 1)*(1.1805 - -1.2090) - 1.2090;

    steeringOutput_i = yawRate_i / -1.5;
