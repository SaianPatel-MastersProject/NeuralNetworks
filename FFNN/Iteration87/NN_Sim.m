...
net = importNetworkFromONNX("SteeringModel_Iteration87_INT.onnx", "InputDataFormats", "BC");

%%
trainingData_Sim = readtable('TrainingData_INT.csv', 'VariableNamingRule','preserve');
...
for i = 1:size(runStruct.data, 1)
    ...
    input_i = [CTE, lookAhead_0, HeadingError, lookAhead_i, prevSteering1];
