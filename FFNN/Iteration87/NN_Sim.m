...
net = importNetworkFromONNX("SteeringModel_Iteration87.onnx", "InputDataFormats", "BC");
...
for i = 1:size(runStruct.data, 1)
    ...
    [projectedCTE, ~, projectedHE, ~, ~] = PostProcessing.PE.fnCalculateProjectedPathError([xV, yV, thetaV], AIW_Data, 40);

    input_i = [CTE, lookAhead_0, HeadingError, lookAhead_i, projectedCTE, projectedHE];
