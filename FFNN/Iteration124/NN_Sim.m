...
net = importNetworkFromONNX("SteeringModel_Iteration124.onnx", "InputDataFormats", "BC");
...
for i = 1:size(runStruct.data, 1)
    ...
    input_i = [CTE, lookAhead_0, HeadingError, lookAhead_i, prevSteering1, prevSteering1*-1.575, projectedCTE, lookAheadHE_i];
