...
net = importNetworkFromONNX("SteeringModel_Iteration45.onnx", "InputDataFormats", "BC");
...
for i = 1:size(runStruct.data, 1)
    ...
    dCurvatureCol = [0; diff(runStruct.data.kappa) ./ 0.01];
    dCurvature = dCurvatureCol(i);
    ...
    input_i = [CTE,curvature, dCurvature, HeadingError];
