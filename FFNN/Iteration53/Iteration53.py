...
data = pd.read_csv('Iteration53\\TrainingDataNorm.csv')

# Separate input features (first 4 columns) and output (5th column)
X = data.iloc[:, :7].values  # First 4 columns as input features
y = data.iloc[:, 7].values   # 5th column as output
...
model.export("Iteration53\\SteeringModel_Iteration53")