...
data = pd.read_csv('D:\\Users\\Saian\\Workspace\\Data\\+NN\\+Iteration2\\TrainingData_b.csv')

# Separate input features (first 4 columns) and output (5th column)
X = data.iloc[:, :8].values  # First 4 columns as input features
y = data.iloc[:, 8].values   # 5th column as output
...
# Save the model
model.save("Iteration2b\\steering_fnn_model_saved.h5")
...
model.export("Iteration2b\\steering_model_NN")