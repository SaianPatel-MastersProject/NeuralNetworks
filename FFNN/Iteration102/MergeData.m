...
for i = 1:size(data, 2)
    ...
    dataArray_i = [data_i.CTE, lookAheadKappa_0, data_i.HeadingError, lookAheadKappa, lookAheadHE, projectedCTE, data_i.steerAngle ];
...
trainingDataNorm = minMaxNormalize(trainingData(:, 1:6));
trainingDataNorm = [trainingDataNorm, trainingData(:,7)];
...
%% View Input Space
plotInputSpace(trainingDataStand, [1:7]);
