...
runsLaps = {
    ...
    'D:\Users\Saian\Workspace\Data\+ProcessedData\2025\FYP04_14\2025_FYP04_14_D7_R03.mat', [1:9], 'BAR';...% BAR
...
for i = 1:size(runsLaps, 1)
    ...
    matFilePath = runsLaps{i,1};
     ...
     if ~isempty(runsLaps{i,2})
         ...
         for k = 1:numel(runsLaps{i,2})

            lapsToExclude = runsLaps{i,2};
            runData = runData(runData.lapNumber ~= lapsToExclude(k), :);
...
%% Artificially Duplicate the Array
for i = 1:3
