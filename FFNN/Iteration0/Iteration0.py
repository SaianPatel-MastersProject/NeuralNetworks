...
data = pd.read_csv('D:\\Users\\Saian\\Workspace\\Data\\+NN\\TraininData.csv')
...
# # Save the model
# model.save("steering_fnn_model_saved.h5")
...
# model.save("steering_fnn_model_x", save_format="tf")
inputs = Input(shape=(4,))
outputs = model(inputs)
keras_model = Model(inputs, outputs)
model.export("steering_model_NN")