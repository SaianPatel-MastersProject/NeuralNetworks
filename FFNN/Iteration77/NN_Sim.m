...
net = importNetworkFromONNX("SteeringModel_Iteration77.onnx", "InputDataFormats", ["BC", "BC"]);
...
for i = 1:size(runStruct.data, 1)
    ...
    ff_input = input_i(1, [2,4]);
    fb_input = input_i(1, [1,3]);

    steeringOutput_i = predict(net, fb_input, ff_input);
