...
net = importNetworkFromONNX("SteeringModel_Iteration79.onnx", "InputDataFormats", "BC");
...
for i = 4:size(NN_Sim_Data,1)
    ...
    input_i = [NN_Sim_Data(i-3, 2:5), NN_Sim_Data(i-2, 2:5), NN_Sim_Data(i-1, 2:5), NN_Sim_Data(i, 2:5)];
