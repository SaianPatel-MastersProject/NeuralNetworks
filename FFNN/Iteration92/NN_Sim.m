...
net = importNetworkFromONNX("SteeringModel_Iteration92.onnx", "InputDataFormats", "BC");
...
for i = 1:size(runStruct.data, 1)
    ...
    input_i = [CTE, lookAhead_0, HeadingError, lookAhead_i, lookAheadHE_i, prevSteering1, projectedCTE];
