...
for i = 1:size(data, 2)
    ...
    for j = 1:size(data_i, 1)
        ...
        % Look ahead in HE
        [~, ~, lookAheadHE_j] = PostProcessing.PE.fnCalculatePathErrorLA([xV, yV, psi(j)], AIW_Data, iLookAhead);
    ...
    dataArray_i = [data_i.CTE, lookAheadKappa_0, data_i.HeadingError, lookAheadKappa, lookAheadHE, prevSteering1, projectedCTE, data_i.steerAngle ];
