...
net = importNetworkFromONNX("SteeringModel_Iteration128.onnx", "InputDataFormats", "BC");
...
for i = 1:size(runStruct.data, 1)
    ...
    input_i = [CTE, lookAhead_0, HeadingError, prevSteering1, prevSteering1*-1.5, projectedCTE, lookAheadHE_i];
