...
% obj = obj.addRun('D:\Users\Saian\Workspace\Data\+ProcessedData\2025\FYP04_21\2025_FYP04_21_D1_R01.mat', true, [2:4]); % SM88
obj = obj.addRun('D:\Users\Saian\Workspace\Data\+ProcessedData\2025\FYP04_21\2025_FYP04_21_D1_R03.mat', true, [2:4]); % SM90



% Add reference lap
obj = obj.addLap('D:\Users\Saian\Workspace\Data\+ProcessedData\2025\FYP02_03\2025_FYP02_03_D1_R02.mat', 31); % SP
% obj = obj.addLap('D:\Users\Saian\Workspace\Data\+ProcessedData\2025\FYP04_21\2025_FYP04_21_D1_R01.mat', 4); % SM88
obj = obj.addLap('D:\Users\Saian\Workspace\Data\+ProcessedData\2025\FYP04_21\2025_FYP04_21_D1_R03.mat', 4); % SM90

% Overwrite the legend cell
obj.plottingTools.legendCell = {'SP', 'SM88', 'SM90'};

%% Stats Test & Metrics
metricsComp = obj.fnMetricsComparison(1, [2]);
ksTestResults = obj.fnKSTest(1,2);
% ksTestResults2 = obj.fnKSTest(1,3);
% ksTestResults3 = obj.fnKSTest(2,3);
