...
net = importNetworkFromONNX("SteeringModel_Iteration41.onnx", "InputDataFormats", "BC");
...
for i = 1:size(runStruct.data, 1)
    ...
    % Look Ahead in Kappa
    lookAhead_i = Utilities.fnGetLookAheadValues(kappaInterp, closestWaypointIdx, 40/0.1, 1);

    input_i = [CTE,lookAhead_i, HeadingError];
