...
net = importNetworkFromONNX("SteeringModel_Iteration15.onnx", "InputDataFormats", "BC");
...
for i = 6:size(runStruct.data, 1)
    ...
    prevSteer = flip((runStruct.data.steerAngle(i-5:i-1)'));
